    ...
    Base.prototype.getTexture = function (url) {
        ...
        return new Promise(function (res) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                // 第一种方式获取
                textTure = new TextureLoader().load(url, function (texture) {
...
var Sphere = /** @class */ (function () {
    ...
    Sphere.prototype.cameraRotation = function (speed) {
        ...
        new TWEEN.Tween({ val: 0 })
            .onUpdate(function () {
            _this.lon += 0.1 * speed;
            var theta = Math$1.degToRad(_this.lon);
    ...
    Lottery3d.turnSelect = function (uInfo, options) {
        ...
        for (var _i = 0, options_1 = options; _i < options_1.length; _i++) {
            ...
            if (item.type === 'variate') {
                var value = get(uInfo, item.value);
                if (item.value === 'sex') {
                    value = sexTurn(value);
                }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        length = 200;
                        randNum = {
                            x: Math$1.randInt(-50, 50),
                            y: Math$1.randInt(-30, 30),
                            z: Math$1.randInt(-50, 50),
                        };
                        CaculatePosition = function (camera, length) {
                            var NewVector = new Vector3(0, 0, 1);
                        ...
                        showing = new TWEEN.Tween({ value: 0 }, TWEEN2)
                            ...
                            var cameraPosition = _this.group.worldToLocal(new Vector3().copy(camera.position));
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        this.lodashAnimates = _(animates_1);
                        return [4 /*yield*/, this.createMeshs()];
                    case 1:
                        _a.sent();
                        this.loopAnimate();
...
export { ImageManger, Lottery3d, Sign3D };
